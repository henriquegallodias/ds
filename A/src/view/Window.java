...
public class Window extends JFrame {
	...
	public Window() {
	    ...
	    paine.add(jbexibir);
	    jbexibir.setBounds(10, 4, 100, 25);
	    ...
	    paine.add(jbplus);
	    jbplus.setBounds(190, 185, 60, 25);
	    
	    paine.add(jbigual);
	    jbigual.setBounds(250, 160, 60, 50);
	    
	    paine.add(jbmenos);
	    jbmenos.setBounds(190, 160	, 60, 25);
	    
	    paine.add(jbdiv);
	    jbdiv.setBounds(190, 110, 60, 25);
	    
	    paine.add(jbvezes);
	    jbvezes.setBounds(190, 135, 60, 25);
	    
	    paine.add(jbponto);
	    jbponto.setBounds(130, 185, 60, 25);
